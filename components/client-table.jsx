                        ...
                        <TableRow key={lead.client}>
                            ...
                            <TableCell>
                                ...
                                <span className="text-xs text-muted-foreground">
                                    {"  "}
                                    {((lead.numResponse / lead.numContacts) * 100).toFixed(1)}%
                                </span>
                            </TableCell>
                            <TableCell>
                                {lead.numHotLeads}
                                ...
                                <span className="text-xs text-muted-foreground">
                                    {"  "}
                                    {((lead.numHotLeads / lead.numResponse) * 100).toFixed(1)}%
                                </span>
                            </TableCell>
                        </TableRow>
                    ))}
                    ...
                    {leads.length > 1 && (
                        <TableRow className="bg-muted/50 font-medium">
                            ...
                            <TableCell>
                                ...
                                <span className="text-xs text-muted-foreground">
                                    {"  "}
                                    {((totals.numResponse / totals.numContacts) * 100).toFixed(1)}%
                                </span>
                            </TableCell>
                            <TableCell>
                                {totals.numHotLeads}
                                ...
                                <span className="text-xs text-muted-foreground">
                                    {"  "}
                                    {((totals.numHotLeads / totals.numResponse) * 100).toFixed(1)}%
                                </span>
                            </TableCell>
                        </TableRow>
                    )}
